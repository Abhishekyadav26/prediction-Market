...
import { predictionMartketContractAddress, predictionMartketContractContract, tokenContract } from "@/app/constants/contracts";
    ...
    const checkApproval = async () => {
        ...
        try {
            const userAllowance = await readContract({
                ...
                params: [account?.address as string, predictionMartketContractAddress]
            });
    ...
    const handleSetApproval = async () => {
        ...
        try {
            const tx = await approve({
                contract: tokenContract,
                spender: predictionMartketContractAddress,
                amount: amount
            });
